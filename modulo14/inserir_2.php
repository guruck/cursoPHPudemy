...
<div class="titulo">Inserir Registro Form
<a href="exercicio.php?dir=modulo14&file=consultar" class="btn btn-success btn-lg">Lista</a> 
</div>
...
<?php 
  ...
  if (count($_POST) > 0){
    ...
    if (!count($erros)){
      ...
      if($result) {
        unset($dados);
        $sucesso['insert'] = "Registro inserido com sucesso!";
      }else{
