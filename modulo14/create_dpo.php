...
<div class="titulo">CREATE - DPO
<a href="exercicio.php?dir=modulo14&file=crud_dpo" class="btn btn-success btn-lg">Lista</a> 
</div>
...
<?php 
  ...
  if (count($_POST) > 0){
    ...
    if (!count($erros)){
      ...
      $params = [
        'nome' => $dados['nome'],
        'nascimento' => $data ? $data->format('Y-m-d') : null,
        'email' => $dados['email'],
        'site' => $dados['site'],
        'filhos' => $dados['filhos'],
        'salario' => $dados['salario'],
      ];
      $result = inserir($params);

      if($result !== null) {
        unset($dados);
        $sucesso['insert'] = $result ;
      }
    }
...
<form action="#" method="post">
  <div class="form-row">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="nascimento" id="nascimento" class="form-control <?= $erros['nascimento']? 'is-invalid' : '' ?>" placeholder="nascimento" value="<?= (isset($dados['nascimento'])? $dados['nascimento'] : '') ?>">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="salario" id="salario" class="form-control <?= $erros['salario']? 'is-invalid' : '' ?>" placeholder="Salário" value="<?= (isset($dados['salario'])? $dados['salario'] : '') ?>">
